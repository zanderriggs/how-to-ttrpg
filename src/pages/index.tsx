...
const links = [
  ...
  },
  {
    ...
    url: '/xp',
    badge: true,
    description: "Here's the XP table because no one ever knows these numbers",
    color: '#1099a8',
  },
  {
...
const IndexPage = (): React.ReactElement => (
  <>
    ...
    <p>
      I just adjusted the auto-generated index.js file to be a super simple example of what the main page could look
      like. idk if we want to have all the info here or link to other pages/domains. But I figured we'd just start the
      thing.
    </p>
    <ul>
      {links.map(link => (
